...
/*   Updated: 2025/04/02 15:30:59 by sde-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void	ScalarConverter::converter(const std::string val)
// {
...
// template <typename T>
// std::ostream& operator<<(std::ostream& streamRef,const ScalarConverter<T>& sconv)
// {
// 	streamRef << sconv<T>.convert() << std::endl;
// 	return (streamRef);
// }
